...
import servicemonitor.dao.CosEventsDao;
 ...
 * @author ktuomain
 */
public class EventBrowser extends VerticalLayout implements Property.ValueChangeListener, Button.ClickListener {
    ...
    CosEventsDao ced = new CosEventsDao();
    ...
    public EventBrowser() {
        ...
        BeanItemContainer<CosEvents> items = new BeanItemContainer<CosEvents>(CosEvents.class);
    ...
    private void search() {
        ...
        BeanItemContainer<CosEvents> items = new BeanItemContainer<CosEvents>(events);
        table.setContainerDataSource(items);
    }
